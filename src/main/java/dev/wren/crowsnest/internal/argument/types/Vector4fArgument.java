...
public class Vector4fArgument implements ArgumentType<Coordinates4> {
    ...
    public Vector4fArgument(boolean pCenterCorrect) {
        this.centerCorrect = pCenterCorrect;
    }

    public static Vector4fArgument vector4f() {
        return new Vector4fArgument(true);
    }

    public static Vector4fArgument vector4f(boolean pCenterCorrect) {
        return new Vector4fArgument(pCenterCorrect);
    }

    public static Vector4f getVector4f(CommandContext<CommandSourceStack> pContext, String pName) {
        ...
        return new Vector4f((float) vec3.x, (float) vec3.y, (float) vec3.z, vec2.x);
    }
