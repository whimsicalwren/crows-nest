...
public class Vector3fArgument implements ArgumentType<Coordinates> {
    ...
    public Vector3fArgument(boolean pCenterCorrect) {
        this.centerCorrect = pCenterCorrect;
    }

    public static Vector3fArgument vector3f() {
        return new Vector3fArgument(true);
    }

    public static Vector3fArgument vector3f(boolean pCenterCorrect) {
        return new Vector3fArgument(pCenterCorrect);
    }

    public static Vector3f getVector3f(CommandContext<CommandSourceStack> pContext, String pName) {
