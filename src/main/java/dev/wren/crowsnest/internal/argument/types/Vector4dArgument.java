...
public class Vector4dArgument implements ArgumentType<Coordinates4> {
    ...
    public Vector4dArgument(boolean pCenterCorrect) {
        this.centerCorrect = pCenterCorrect;
    }

    public static Vector4dArgument vector4d() {
        return new Vector4dArgument(true);
    }

    public static Vector4dArgument vector4d(boolean pCenterCorrect) {
        return new Vector4dArgument(pCenterCorrect);
    }

    public static Vector4d getVector4d(CommandContext<CommandSourceStack> pContext, String pName) {
        ...
        return new Vector4d(vec3.x, vec3.y, vec3.z, vec2.x);
    }
