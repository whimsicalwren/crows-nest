...
public class QuaternionfArgument implements ArgumentType<Coordinates4> {
    ...
    public QuaternionfArgument(boolean pCenterCorrect) {
        this.centerCorrect = pCenterCorrect;
    }

    public static QuaternionfArgument quaternionf() {
        return new QuaternionfArgument(true);
    }

    public static QuaternionfArgument quaternionf(boolean pCenterCorrect) {
        return new QuaternionfArgument(pCenterCorrect);
    }

    public static Quaternionf getQuaternionf(CommandContext<CommandSourceStack> pContext, String pName) {
        ...
        return new Quaternionf(vec3.x, vec3.y, vec3.z, vec2.x);
    }
